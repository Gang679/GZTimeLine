...
//        cell = [[GZTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:rell];
    ...
    if (indexPath.row==0) {
        ...
        cell.GZLine.sd_layout.topEqualToView(cell.point).leftSpaceToView(cell.contentView,8.5).widthIs(1).bottomSpaceToView(cell.contentView, 0);
    }
    ...
    if (indexPath.row == self.TimeLineData.count - 1) {
        ...
        cell.GZLine.sd_layout.topEqualToView(cell.point).leftSpaceToView(cell.contentView,8.5).widthIs(1).heightIs(0);
    }
